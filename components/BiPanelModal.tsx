    ...
    <Modal isOpen={isOpen} onClose={onClose} title={`Editar: ${panelData.panelInfo.name}`}>
      <form onSubmit={handleSubmit} className="space-y-4">
        ...
        <div>
          ...
          <input type="text" name="name" value={formData.panelInfo.name || ''} onChange={handleChangePanelInfo} className="mt-1 block w-full rounded-md border-gray-300 shadow-sm sm:text-sm bg-white text-gray-900" />
        </div>
        
        <div>
          <label htmlFor="embed_url" className="block text-sm font-medium text-gray-700">URL del Panel</label>
          <input type="url" name="embed_url" value={formData.panelInfo.embed_url || ''} onChange={handleChangePanelInfo} className="mt-1 block w-full rounded-md border-gray-300 shadow-sm sm:text-sm bg-white text-gray-900" />
        </div>
        ...
        <div>
          ...
          <select name="status" id="status" value={formData.clientPanel.status} onChange={handleChangeClientPanel} className="mt-1 block w-full rounded-md border-gray-300 shadow-sm sm:text-sm bg-white text-gray-900">
        ...
        <div>
            ...
            <input type="range" name="progress_pct" id="progress_pct" min="0" max="100" value={formData.clientPanel.progress_pct || 0} onChange={handleChangeClientPanel} className="w-full h-2 bg-gray-200 rounded-lg appearance-none cursor-pointer" />
        </div>

        <div>
          <label htmlFor="owner_user_id" className="block text-sm font-medium text-gray-700">Responsable</label>
          <select name="owner_user_id" id="owner_user_id" value={formData.clientPanel.owner_user_id} onChange={handleChangeClientPanel} className="mt-1 block w-full rounded-md border-gray-300 shadow-sm sm:text-sm bg-white text-gray-900">
        ...
        <div>
          ...
          <input type="date" name="target_date" id="target_date" value={formData.clientPanel.target_date} onChange={handleChangeClientPanel} className="mt-1 block w-full rounded-md border-gray-300 shadow-sm sm:text-sm bg-white text-gray-900" />
        </div>

        <div>
          <label htmlFor="notes" className="block text-sm font-medium text-gray-700">Notas</label>
          <textarea name="notes" id="notes" value={formData.clientPanel.notes || ''} onChange={handleChangeClientPanel} rows={3} className="mt-1 block w-full rounded-md border-gray-300 shadow-sm sm:text-sm bg-white text-gray-900" />
        </div>
